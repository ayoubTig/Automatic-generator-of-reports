...
// 		System.out.println("----------"+Dao.ExisteDoc(doc.getUrl_Doc(), doc.getDate_Viste(),doc.getNom_entreprise()));
// Dao.updateS(1,(int)Dao.ExisteDoc(doc.getUrl_Doc(), doc.getDate_Viste(),doc.getNom_entreprise()).getIdDoc());
...
//		cons.add( cons8);
//		cons.add(cons9 );
//		Insertion insert=new Insertion("..\\rma\\template.docx","C:\\Users\\ACER\\Desktop\\nulll.docx");
//		Insertion.template = "..\\rma\\template.docx";
//		Insertion.tmp="C:\\Users\\ACER\\Desktop\\nulll.docx";
